...
import { createMCPReport } from '../actions';

export default async function NewMCPReportPage() {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-slate-900">New MCP Report</h2>
                    <p className="text-sm text-slate-500">Submit a new Monthly Church Program report</p>
                </div>
            </div>
            ...
            <Card>
                ...
                <CardContent>
                    <form action={createMCPReport} className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                                rows="10"
                                placeholder="Describe the Monthly Church Program activities, events, and outcomes for this period..."
