...
import { createMoveReport } from '../actions';

export default async function NewMoveReportPage() {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-slate-900">New Move Report</h2>
                    <p className="text-sm text-slate-500">Submit a new logistical movement report</p>
                </div>
            </div>
            ...
            <Card>
                ...
                <CardContent>
                    <form action={createMoveReport} className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                                rows="10"
                                placeholder="Describe logistical changes, movements, relocations, and related activities for this period..."
